          ...
          {current && (
            <div className="flex flex-col items-center">
              ...
              <div className="w-full flex justify-between items-center mt-6 px-4">
                <button onClick={prev} className="p-3 rounded-full bg-[#001c27] border border-white/10 text-white hover:bg-[#53ddfc]/20 transition-colors">
                ...
                <button onClick={next} className="p-3 rounded-full bg-[#001c27] border border-white/10 text-white hover:bg-[#53ddfc]/20 transition-colors">
